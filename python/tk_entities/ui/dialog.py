...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtWidgets.QApplication.translate("Dialog", "The Current Sgtk Environment", None, QtWidgets.QApplication.UnicodeUTF8))
        self.ent_label.setText(QtWidgets.QApplication.translate("Dialog", "Entities", None, QtWidgets.QApplication.UnicodeUTF8))
        self.fld_label.setText(QtWidgets.QApplication.translate("Dialog", "Fields", None, QtWidgets.QApplication.UnicodeUTF8))
